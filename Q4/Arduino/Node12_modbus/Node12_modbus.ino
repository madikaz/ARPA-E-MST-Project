...
//OLocalVertex s = OLocalVertex(0x415786A9,4,0,5,0.13,3.3,2,10);
OLocalVertex s = OLocalVertex(0x4151C692,4,0,5,0.13,3.3,3,10);
...
//  g.addInNeighbor(0x415786D3,2,0,0); // node 10
    g.addInNeighbor(0x4174F1AA,2,0,0); // node 1 as node 10
